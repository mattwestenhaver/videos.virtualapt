    ...
    return (
      <div className="each-video" key={this.props.index}>
        {this.props.video.thumbnail
          ? <a href={this.props.video.url} target="_blank"><img src={this.props.video.thumbnail} alt={this.props.video.title} /></a>
          : <a href={this.props.video.url} target="_blank"><img src={noThumbnail} alt='no thumbnail available' /></a>
        }
